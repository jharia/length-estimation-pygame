...
class TestGame:
    ...
    def saveLog(self): 
        f = open('log.txt','a')
        f.write('---------------------------------------')
        strToWrite = 'Coordinates: left_x1, right_x1, y_x1, left_x2, left_x2+length_x2, y_x2'+ \
        str([self.left_x1, self.right_x1, self.y_x1, self.left_x2, self.left_x2+self.length_x2, self.y_x2])
        f.write(strToWrite)
